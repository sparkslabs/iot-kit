...
#include "../test_support/MockSerial.h"
#include "../test_support/MockServo.h"
#include "../test_support/MockString.cpp"
#include <ctype.h>
...
// This allows the code to simulate the Flash embedding of strings
#define F(X) (X)
...
#ifdef TINY
#include "OvenHostTiny.ino"
#else
#include "OvenHost.ino"
#endif
